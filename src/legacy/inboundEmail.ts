...
// (e.g. cash purchases with no bank transaction). Only reachable when
// ENABLE_EMAIL_INGESTION=true; see app/api/inbound-email/route.ts.

import { NextRequest, NextResponse } from 'next/server'
import { Webhook } from 'svix'
import { getAgentMailClient, fetchAttachmentBase64 } from './agentmail'
import { parseReceiptFile, parseReceiptEmailText } from './receiptOcr'
...
export async function handleInboundEmailWebhook(request: NextRequest): Promise<NextResponse> {
